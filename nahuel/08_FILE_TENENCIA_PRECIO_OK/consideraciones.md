...
El nombre del reporte es FILE_TENENCIA_PRECIO
...
En la BD estan asociado a objetos con nomenclatura 84_ENT_TENENCIA_PRECIO.

En los entregables se debe de incluir un archivo excel con 100 registros, la información de encabezados, tipo, longitud y formato de datos estan especificados en el excel FILE_TENENCIA_PRECIO.
