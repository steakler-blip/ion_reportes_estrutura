...
El nombre del reporte es CANASTA_REPORTOS
...
En la BD estan asociado a objetos con nomenclatura 122_ENT_REPORTOS_CANASTA.

En los entregables se debe de incluir un archivo excel con 100 registros, la información de encabezados, tipo, longitud y formato de datos estan especificados en el excel CANASTA_REPORTOS.
