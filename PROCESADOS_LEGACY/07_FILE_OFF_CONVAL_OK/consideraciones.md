...
El nombre del reporte es FILE_OFF_CONVAL
...
En la BD estan asociado a objetos con nomenclatura 133_ENT_OFF.

En los entregables se debe de incluir un archivo excel con 100 registros, la información de encabezados, tipo, longitud y formato de datos estan especificados en el excel FILE_OFF_CONVAL.
