...
La carpeta principal tiene el nombre del reporte a trabajar, existen 2 archivos de excel con la estructura de datos y la configuración de los campos, y 1 carpeta llamada CATALOGOS.
