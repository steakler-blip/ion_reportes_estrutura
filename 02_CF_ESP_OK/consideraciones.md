...
El nombre del reporte es CF_ESP
...
En la BD estan asociado a objetos con nomenclatura 93_ENT_CF.

En los entregables se debe de incluir un archivo excel con 100 registros, la información de encabezados, tipo, longitud y formato de datos estan especificados en el excel CF_ESP.
